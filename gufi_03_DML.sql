...
SELECT NomeUsuario [Usuário],TituloTipoUsuario Tipo,DataEvento [Data], NomeFantasia [Local],TituloTipoEvento Tema, NomeEvento Evento,Descricao,AcessoLivre,Situacao FROM Eventos E
